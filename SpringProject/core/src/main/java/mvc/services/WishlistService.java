...
public class WishlistService {
     ...
     */
    public void addInWishlist(HttpSession session, GoodInfo good) {
    ...
    @Transactional
    public List<WishlistInfo> getByUser_id(Long user_id){
        return wishlist.findByUser_Id(user_id);
    }

    @Transactional
    public List<WishlistInfo> getByUser_login(String login){
